...
export default {
  ...
  methods: {
    ...
    handleDelete(row, index) {
      console.log(index);
      this.$confirm("确定要删除这条音频数据吗?", "温馨提示", {
